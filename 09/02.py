...
c = nonlinear_pendulum(0,0.2,0.04,60,1.2)
c.calculate()
c.plot_2D("green")
...
a = nonlinear_pendulum(0,0.2,0.04,600,0.5)
a.calculate()
a.plot_phase()
pl.legend()
pl.show()

a = nonlinear_pendulum(0,0.2,0.04,600,1.2)
a.calculate()
a.plot_phase()
pl.legend()
pl.show()
...
b=nonlinear_pendulum(0,0.2,3*math.pi/800,10000 * math.pi,1.2)
b.calculate()
b.plot_attractor()
pl.legend()
pl.show()

b=nonlinear_pendulum(0,0.2,0.75*math.pi/800,10000 * math.pi,1.2)
b.calculate()
b.plot_attractor()
pl.legend()
pl.show()
